...
class App extends React.Component {
      ...
      <div className="container">
        <div>
          <label>
            ...
            <Switch
              onChange={v => this.handleChange("switchOne", v)}
        ...
        <div>
          <label>
            <span>Work</span>
            <Switch
              onChange={v => this.handleChange("switchTwo", v)}
        ...
        <div>
          <label>
            <span>Sleep</span>
            <Switch
              onChange={v => this.handleChange("switchThree", v)}
  ...
  handleChange(key, v) {
    const switches = ["switchOne", "switchTwo", "switchThree"].filter(
      x => x !== key
    );
